...
const initialState: UsersPropsType = {
    users: [
        ...
        {id: v1(), photoUrl: 'https://nymock.com/cdn/shop/files/7_40dd5edf-993c-4e5e-abc8-eff4c4b7c73b.jpg?v=1695932057', fullName: 'Oleg N.', status: 'I\'m Oleg', location: {country: 'Russia', city: 'Moscow'}, followed: true},
        ...
        {id: v1(), photoUrl: 'https://i.pinimg.com/736x/84/91/3c/84913ce28e78c83ae28eae12fd1eb64a.jpg', fullName: 'Valeriy P.', status: 'I like pizza with cheese', location: {country: 'Belarus', city: 'Minsk'}, followed: true},
    ],
}
